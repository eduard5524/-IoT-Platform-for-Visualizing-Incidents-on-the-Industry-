...
customElements.define('compodoc-menu', class extends HTMLElement {
    ...
    <ul class="list">
        <li class="title">
            <a href="index.html" data-type="index-link">mim-frontend documentation</a>
        </li>
        <li class="divider"></li>
                        ...
                        <a href="modules/AppModule.html" data-type="entity-link">AppModule</a>
                            <li class="chapter inner">
                                <div class="simple menu-toggler" data-toggle="collapse"
                                    ${ isNormalMode ? 'data-target="#components-links-module-AppModule-ca0c244fa439a4ca2c170361bffe835a"' : 'data-target="#xs-components-links-module-AppModule-ca0c244fa439a4ca2c170361bffe835a"' }>
                                    <span class="icon ion-md-cog"></span>
                                    <span>Components</span>
                                    <span class="icon ion-ios-arrow-down"></span>
                                </div>
                                <ul class="links collapse"
                                    ${ isNormalMode ? 'id="components-links-module-AppModule-ca0c244fa439a4ca2c170361bffe835a"' : 'id="xs-components-links-module-AppModule-ca0c244fa439a4ca2c170361bffe835a"' }>
                                        <li class="link">
